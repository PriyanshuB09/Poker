...
$(() => {
  ...
  $("#learn-btn").click(() => toggleLearnModal());
  $(".learn-modal-close").click(() => toggleLearnModal());

  $("#store-btn").click(() => toggleStoreModal());
  $(".store-modal-close").click(() => toggleStoreModal());
...
function toggleLearnModal() {
  if ($(".learn-modal").css("top") == "50px") {
    $(".learn-modal").css("top", "-100vh");
    $(".blur-div").fadeOut();
  } else {
    $(".learn-modal").css("top", "50px");
    $(".blur-div").fadeIn();
  }
}

function toggleStoreModal() {
  if ($(".store-modal").css("top") == "50px") {
    $(".store-modal").css("top", "-100vh");
    $(".blur-div").fadeOut();
  } else {
    $(".store-modal").css("top", "50px");
    $(".blur-div").fadeIn();
  }
}
...
function loadData() {
  ...
  $("#ranked-wins-data").text(
    `${userData.rankedWins ? userData.rankedWins : ""}`
  );
